...
import { ImageViewerConfig, CustomEvent } from './ng8-viewer.config.model';
...
const DEFAULT_CONFIG: ImageViewerConfig = {
  ...
  btnIcons: {
    ...
    rotateCounterClockwise: 'rotate_right',
    next: 'navigate_next',
...
@Component({
  selector: 'ng8-viewer',
  templateUrl: './ng8-viewer.component.html',
  styleUrls: ['./ng8-viewer.component.scss']
})
export class Ng8ViewerComponent implements OnInit {
